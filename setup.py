...
setup(
    ...
    url='https://github.com/gosselico/pretix-sortir',
    ...
    # Project URLs
    project_urls={
        'Documentation': 'https://github.com/gosselico/pretix-sortir/blob/main/README.md',
        'Bug Reports': 'https://github.com/gosselico/pretix-sortir/issues',
        'Source': 'https://github.com/gosselico/pretix-sortir',
    },
)